								...
								@if(Route::has('login'))
									@auth
										@if (Auth::user()->utype == 'admin')
											<li class="menu-item menu-item-has-children parent" >
												<a title="My Accout" href="#">My Accout ( {{ Auth::user()->name }} )<i class="fa fa-angle-down" aria-hidden="true"></i></a>
												<ul class="submenu curency" >
													<li class="menu-item" >
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2022 eComBD Ltd. All rights reserved</p>
					</div>
